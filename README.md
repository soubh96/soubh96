...
```🎯 ROLE: Scientist at Central Research Laboratory (CRL-BEL)```

```🚀 FOCUS: Generative AI Security (GenAIsec) | IoT Systems | Enterprise Network Architecture```

Hello! I'm **Soubhik Baral**, a scientist at **Central Research Laboratory (CRL-BEL)**, specializing in **Generative AI Security (GenAIsec)**, **Large Language Model (LLM) Runtime Defense**, **IoT & Smart Systems**, and **Enterprise Network Architecture**. 

*   **🛡️ AI Security & Agentic Orchestration:** My core research and engineering framework is heavily focused on the absolute cutting edge. I architect intelligent **multi-agent state machines** using LangGraph, build robust **Model Context Protocol (MCP)** integrations, and develop zero-trust **LLM firewalls and safety gateways** to protect enterprise infrastructure against prompt injection, data poisoning, and malicious exploits. 
*   **🌐 IoT Systems & Hardware-Software Co-design:** Beyond core software security, I focus deeply on low-level engineering for wireless sensor networks, custom **LoRa/LoRaWAN gateway development**, and edge-integrated IoT device solutions. I am highly experienced in deploying optimized computational intelligence and custom systemd automation services directly onto resource-constrained computing platforms, bridging the gap between embedded physical deployments and highly scalable software backends.
*   **⚙️ Advanced Networking & Distributed Systems:** Tying these layers together is my deep-tech foundation in communication topologies. I design and optimize complex environments ranging from software-defined networking (SDN) and OpenFlow routing protocols to industrial IoT infrastructure and cloud-native private 4G cellular infrastructure (Magma Orchestration). My passion lies in ensuring that high-throughput, edge-integrated systems remain absolutely private, performant, and resilient under strict zero-trust parameters.

> ⚽ **Beyond the Lab:** When I'm not designing automated policy enforcement engines or debugging network configurations, I enjoy **playing football** to balance the mental rigor of research with physical activity. Whether it's optimizing sub-second security proxy execution or enjoying a fast-paced match with friends, I strive to keep a healthy balance between work and play.

Feel free to connect with me if you're interested in LLM safety gateways, multi-agent workflows, IoT architecture, or just a fun football chat!
...
| **IoT & Gateways** | IoT framework design, Wireless Sensor Networks (WSN), LoRa gateway development, Smart Device Ecosystems |
| **Embedded Platforms** | Embedded Linux system engineering, Raspberry Pi, BeagleBoard ecosystems, Hardware-Software integration |
| **Networking & Wireless** | TCP/IP, HTTP/HTTPS, LoRaWAN topology, SDN, OpenFlow, Private 4G Networks (Magma Orchestration) |
...
I’m a fan of pushing boundaries—whether it’s engineering self-healing autonomous routing paths for multi-agent systems, tweaking low-level IoT gateways, or scoring a clinical goal on the football field.
